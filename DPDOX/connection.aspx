<%@ Page Language="C#" AutoEventWireup="true" CodeFile="connection.aspx.cs" Inherits="DPDOX_connection" %>
  ...
  <div class="container-fluid">
   <div class="collapse navbar-collapse" id="myNavbar">
      <table><tr>
        ...
        <td><Button ID="btn_connection"class="btn btn-primary transparent-style mr-3" Onclick="btn_connection_Click"> Connection</Button>&nbsp</td>
...
<div class="container text-center">
  <asp:Button ID="btn_approved" runat="server" Text="My Connections" class="btn btn-success transparent-style mr-3" Width="100%" OnClick="btn_myconnection_Click"/>
</div><br />
<div class="container text-center">
  <asp:Button ID="btn_pending" runat="server" Text="Pending Connection (Following)" class="btn btn-secondary transparent-style mr-3" Width="100%" Onclick="btn_pending_Click"/>
</div><br />
<div class="container text-center">
  <asp:Label ID="lbl_connection_rqst" runat="server" Text="Connection Requests..." style="font-family:Courier New; color:darkcyan" Font-Size="X-Large" Font-Bold="false"></asp:Label>
</div>
...
<ItemStyle BorderColor="White" BorderWidth="50px" BackColor="#F7F6F3" ForeColor="#333333"></ItemStyle>
        ...
        <ItemTemplate >
            <table border="0"  style="">
                ...
                <tr>
                    <td><asp:Button ID="btn_delete" runat="server" style="width:100%" Text="Reject" class="btn btn-danger transparent-style mr-3" CommandName="reject" Width="98%"/></td>
                    <td colspan="3"><asp:Button ID="btn_approve" runat="server" Text="Approve" class="btn btn-success transparent-style mr-3" CommandName="approve" Width="98%"/></td>
                </tr>
                </tr>
            </table>
            <table>
