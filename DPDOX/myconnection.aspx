<%@ Page Language="C#" AutoEventWireup="true" CodeFile="myconnection.aspx.cs" Inherits="DPDOX_myconnection" %>
...
<head>
    ...
    <title>Cupit | My Connections</title>
...
<br />
<div class="container text-center">
  <asp:Label ID="lbl_connection_rqst" runat="server" Text="-- My Connections --" style="font-family:Courier New; color:darkcyan" Font-Size="X-Large" Font-Bold="false"></asp:Label>
</div>
...
<ItemStyle BorderColor="White" BorderWidth="50px" BackColor="#F7F6F3" ForeColor="#333333"></ItemStyle>
        ...
        <ItemTemplate >
            <table border="0"  style="">
                ...
                <tr><td style="text-align: center"><asp:Image ID="img_gmail" runat="server" src="Content/Design%20Images/gmail_logo.png" Height="20" Width="20"/></td><td>:&nbsp</td><td><asp:Label ID="lbl_cust_email" runat="server" Text='<%#Eval("c_email")%>' Visible="true"></asp:Label></td></tr>
                <tr><td style="text-align: center"><asp:Image ID="img_whatsapp" runat="server" src="Content/Design%20Images/whatsapp_logo.png" Height="20" Width="20"/></td><td>:&nbsp</td><td><asp:Label ID="lbl_cust_num" runat="server" Text='<%#Eval("c_phone") %>'></asp:Label>  </td></tr>
                <tr>
