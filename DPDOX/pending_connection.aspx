<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pending_connection.aspx.cs" Inherits="DPDOX_pending_connection" %>
...
<head>
    ...
    <title>Cupit | Pending Connections</title>
...
<br />
<div class="container text-center">
  <asp:Label ID="lbl_connection_rqst" runat="server" Text="Pending Connections..." style="font-family:Courier New; color:darkcyan" Font-Size="X-Large" Font-Bold="false"></asp:Label>
</div>
...
<ItemStyle BorderColor="White" BorderWidth="50px" BackColor="#F7F6F3" ForeColor="#333333"></ItemStyle>
        ...
        <ItemTemplate >
            <table border="0"  style="">
                ...
                <tr>
                    <td colspan="4"><asp:Button ID="btn_approve" runat="server" Text="Cancel Request" class="btn btn-primary transparent-style mr-3" CommandName="cancel" Width="98%"/></td>
                </tr>
                </tr>
            </table>
            <table>
