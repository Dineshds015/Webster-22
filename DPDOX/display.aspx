<%@ Page Language="C#" AutoEventWireup="true" CodeFile="display.aspx.cs" Inherits="DPDOX_Default" %>
  ...
  <div class="container-fluid">
   <div class="collapse navbar-collapse" id="myNavbar">
      <table><tr>
        ...
        <td><asp:Button ID="btn_connection" runat="server" Text="Connection" class="btn btn-primary transparent-style mr-3" Onclick="btn_connection_Click"></asp:Button>&nbsp</td>
