<%@ Page Language="C#" AutoEventWireup="true" CodeFile="display_city.aspx.cs" Inherits="DPDOX_display_city" %>
...
<ItemStyle BorderColor="White" BorderWidth="50px" BackColor="#F7F6F3" ForeColor="#333333"></ItemStyle>
        ...
        <ItemTemplate >
            <table>
                <tr>
                    <td rowspan="5" Height="150px" Width="300px" style="background-color:antiquewhite; filter-blur:5px; border-radius:20px" align="center" style=" box-shadow: inset 0px 0px 10px rgba(0,0,0,0.5);"><asp:Image ID="img_c_image" style=" box-shadow: inset 0px 0px 10px rgba(0,0,0,0.5);" runat="server" ImageUrl='<%#Eval("c_dp") %>' Type="String" Height="150px" Width="140px" AlternateText="Picture not found"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                ...
                <tr><td><asp:Button ID="btn_connect" runat="server" Text="Connect +" class="btn btn-warning shadow" height="40" Width="300" Font-Bold="True" Font-Size="Medium" CommandName="enquiry"/></td>
                    <td><asp:Label ID="lbl_c_date" runat="server" style="color:#8e8e8e" Text='<%#Eval("c_date","{0:dd/MM/yyyy | hh:mm:ss}") %>'></asp:Label>  </td>
                </tr>
            </table>
            <table>
                <tr>
                    <td><asp:Label ID="lbl_prod_id" runat="server" Text='<%#Eval("c_id")%>' Visible="false"></asp:Label></td>
                </tr>
            </table>
        </ItemTemplate>
...
<td><asp:Label ID="llb" runat="server" Text="jolly llb"></asp:Label></td>
</br></br>
